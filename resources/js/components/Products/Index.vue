<template>
    <section class="text-gray-700 body-front">
        <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-wrap -m-4" v-if="!products.length">
                <div class="lg:w-1/4 md:w-1/2 p-4 w-full mb-4">
                    <a
                        href=""
                        class="block relative h-48 round overflow-hidden"
                    >
                        <img
                            src="https://dummyimage.com/420x620"
                            alt="ecommerce"
                    ...
                    <div class="mt-4">
                        <h3
                            class="text-gray-500 text-xs tracking-widset title-front mb-1 uppercase inline block mr-2"
                        >
                            N/A
                        </h3>
                        <h2
                            class="text-gray-900 title-front text-lg font-medium"
                        >
                            Loading....
                        </h2>
                        <p class="mt-1">0.00</p>
